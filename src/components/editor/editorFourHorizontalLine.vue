<script setup lang="ts">
    ...
    import { IFourHorizontalLine, IInputField } from 'src/interface/editorInputFeild';
    ...
    const formModal = reactive<IFourHorizontalLine>({});
            ...
            if (valid) {
                ...
                if (isAdd) {
                    props.editor?.executeCommand(
                        EExecuteCommand.INSERT_HORIZONTAL_LINE,
                        false,
                        obj
                    );
                } else {
